    ...
    if (hasOpe121SlackPublicationLedger) {
      ...
      for (const [tables, length] of contracts) {
        ...
        const expectedLength =
          hostBindingMetadataCount +
          acceptedHostAuthorityCount +
      ...
      const tableCount = (hasCurrentMainActivityLedger ? 338 : 219) + 3;
