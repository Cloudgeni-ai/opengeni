    ...
    try {
      ...
      await admin`
        insert into sessions (
          ...
          (${sessionA}, ${account!.id}, ${workspaceA}, 'same workspace', 'scripted-model', 'none', ${sessionA}, 'idle', ${admin.json({ mode: "workspace_default", inheritedFromSessionId: null })}),
          (${sessionB}, ${account!.id}, ${workspaceB}, 'foreign workspace', 'scripted-model', 'none', ${sessionB}, 'idle', ${admin.json({ mode: "workspace_default", inheritedFromSessionId: null })})`;
