 ...
 * Current-runtime denial and conversion are exercised by migration-0459 and
...
export async function acquirePreKnowledgeTestDatabase(
  ...
  try {
    ...
    await admin`INSERT INTO schema_migrations(name) VALUES ('0459_unified_knowledge.sql')`;
    await migrate(blank.databaseUrl);
    await admin`DELETE FROM schema_migrations WHERE name='0459_unified_knowledge.sql'`;
