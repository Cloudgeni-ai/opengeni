...
describe("migrations 0353-0355 automatic session title policy fence", () => {
  ...
  test("keeps custom old binaries ready immediately after 0353 and converges deferred roles", async () => {
    ...
    const expectedPost0353EvaluatorGaps = [
      "runtime privilege tables are missing: connect_attempts, external_identity_links, external_link_task_authorities, external_link_turn_authorities, host_mcp_bindings, host_mcp_delegations, host_mcp_task_authorities, host_mcp_turn_authorities, session_attempt_model_context_snapshots, workspace_artifact_uploads",
      "protected tables are missing: connect_attempts, external_identities, external_identity_links, external_link_task_authorities, external_link_turn_authorities, host_mcp_bindings, host_mcp_delegations, host_mcp_task_authorities, host_mcp_turn_authorities, session_attempt_model_context_snapshots, workspace_artifact_uploads",
