...
const source = readFileSync(
  new URL("../drizzle/0427_session_agent_access_scope.sql", import.meta.url),
  "utf8",
);

test("0427 is a rolling, default-preserving sessions column addition", () => {
...
test("0427 pins the closed value sets and the paired end-user label", () => {
...
test("0427 indexes the end-user pair only for labelled sessions", () => {
