// Regression companion for 0496_supervised_command_settlement.sql.
...
test("0496 rolling expansion applies under the non-bypass owner with FORCE RLS intact", async () => {
