...
const migrationUrl = new URL(
  "../drizzle/0326_slack_orchestration_delivery_events.sql",
  import.meta.url,
);
...
beforeAll(async () => {
  shared = await acquireSharedTestDatabase("migration-0326-slack-orchestration-delivery-events");
});
...
describe("migration 0326 Slack orchestration delivery events", () => {
