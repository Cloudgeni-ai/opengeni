...
const fenceMigrationUrl = new URL(
  "../drizzle/0347_automatic_session_title_policy_fence.sql",
  import.meta.url,
);
const quarantineIndexMigrationUrl = new URL(
  "../drizzle/0348_automatic_session_title_quarantine_index.sql",
  import.meta.url,
);
...
describe("migrations 0347-0349 automatic session title policy fence", () => {
