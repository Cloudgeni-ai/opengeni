...
ALTER FUNCTION check_organization_tenancy_parity(uuid, integer, integer)
  RENAME TO check_organization_tenancy_parity_pre_0336;
ALTER FUNCTION check_organization_tenancy_parity_pre_0336(uuid, integer, integer)
  SET SCHEMA opengeni_private;
REVOKE ALL ON FUNCTION
  opengeni_private.check_organization_tenancy_parity_pre_0336(uuid, integer, integer)
  FROM PUBLIC;
...
BEGIN
  result := opengeni_private.check_organization_tenancy_parity_pre_0336(
