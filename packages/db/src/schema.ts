...
export const workspaceEnvironments = pgTable(
  ...
  (table) => ({
    workspaceName: uniqueIndex("workspace_environments_workspace_name_idx").on(
      table.workspaceId,
      table.name,
    ),
    workspaceCreated: index("workspace_environments_workspace_created_idx").on(
      table.workspaceId,
      table.createdAt,
    ),
  }),
...
export const workspaceEnvironmentVariables = pgTable(
  "workspace_environment_variables",
  {
    ...
    environmentId: uuid("environment_id")
      .notNull()
      .references(() => workspaceEnvironments.id, { onDelete: "cascade" }),
    name: text("name").notNull(),
  ...
  (table) => ({
    environmentName: uniqueIndex("workspace_environment_variables_env_name_idx").on(
      table.workspaceId,
      table.environmentId,
      table.name,
    ),
    environment: index("workspace_environment_variables_workspace_env_idx").on(
      table.workspaceId,
      table.environmentId,
    ),
  }),
...
export const sessions = pgTable(
  "sessions",
  {
    ...
    environmentId: uuid("environment_id").references(() => workspaceEnvironments.id, {
      onDelete: "set null",
    }),
...
export const scheduledTasks = pgTable(
  ...
  (table) => ({
    ...
    environment: index("scheduled_tasks_environment_idx").on(
      table.workspaceId,
      table.environmentId,
    ),
  }),
