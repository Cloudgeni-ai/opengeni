...
export interface Heartbeat {
  ...
  attachedBrowserInventory:
    | AttachedBrowserInventorySnapshot
    | undefined;
  /**
   * Optional live snapshot, sampled off the control loop. Absence means an
   * older runner; never erase its Hello-derived state. Does not renew consent.
   */
...
export const Heartbeat: MessageFns<Heartbeat> = {
  encode(message: Heartbeat, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.desktopStatus !== undefined) {
      DesktopStatus.encode(message.desktopStatus, writer.uint32(74).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 9: {
          ...
          message.desktopStatus = DesktopStatus.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): Heartbeat {
    return {
      ...
      attachedBrowserInventory: isSet(object.attachedBrowserInventory)
        ...
        : undefined,
      desktopStatus: isSet(object.desktopStatus)
        ? DesktopStatus.fromJSON(object.desktopStatus)
        : isSet(object.desktop_status)
        ? DesktopStatus.fromJSON(object.desktop_status)
        : undefined,
    };
  },
  ...
  toJSON(message: Heartbeat): unknown {
    ...
    if (message.desktopStatus !== undefined) {
      obj.desktopStatus = DesktopStatus.toJSON(message.desktopStatus);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Heartbeat>, I>>(object: I): Heartbeat {
    ...
    message.attachedBrowserInventory =
      (object.attachedBrowserInventory !== undefined && object.attachedBrowserInventory !== null)
        ...
        : undefined;
    message.desktopStatus = (object.desktopStatus !== undefined && object.desktopStatus !== null)
      ? DesktopStatus.fromPartial(object.desktopStatus)
      : undefined;
    return message;
  },
};
...
export const DesktopStatus: MessageFns<DesktopStatus> = {
  encode(message: DesktopStatus, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DesktopStatus {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): DesktopStatus {
    return {
      available: isSet(object.available) ? globalThis.Boolean(object.available) : false,
      unavailableReason: isSet(object.unavailableReason)
        ? globalThis.String(object.unavailableReason)
  ...
  toJSON(message: DesktopStatus): unknown {
    const obj: any = {};
    if (message.available !== false) {
  ...
  create<I extends Exact<DeepPartial<DesktopStatus>, I>>(base?: I): DesktopStatus {
    return DesktopStatus.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DesktopStatus>, I>>(object: I): DesktopStatus {
    const message = createBaseDesktopStatus();
