...
export function testSettings(overrides: Partial<Settings> = {}): Settings {
  return {
    ...
    appsEnabled: false,
    appOriginTemplate: undefined,
    appHostResolverKey: undefined,
    ...
    workClaimMutationsEnabled: true,
    ...
    openSandboxBaseUrl: undefined,
    openSandboxApiKey: undefined,
    ...
    workspaceControlLockTimeoutMs: 20_000,
