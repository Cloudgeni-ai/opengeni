...
export function testSettings(overrides: Partial<Settings> = {}): Settings {
  return {
    ...
    temporalTlsServerName: undefined,
    temporalTlsRootCaCertificateBase64: undefined,
    temporalTlsClientCertificateBase64: undefined,
    temporalTlsClientPrivateKeyBase64: undefined,
    ...
    videoGenerationPollIntervalMs: 5_000,
    videoGenerationRecoveryDeadlineMs: 2 * 60 * 60_000,
    videoGenerationReferenceUrlTtlSeconds: 60 * 60,
    videoGenerationMaxConcurrentPerWorkspace: 2,
    ...
    voiceInputOpenaiEnabled: true,
    voiceInputOpenaiApiKey: undefined,
    voiceInputOpenaiBaseUrl: undefined,
    voiceInputOpenaiModel: "gpt-transcribe",
    voiceInputAzureEnabled: true,
    voiceInputAzureEndpoint: undefined,
    voiceInputAzureDeployment: undefined,
    ...
    dockerWorkspaceBaseDir: undefined,
    kubernetesImage: "opengeni-sandbox:local",
    kubernetesNamespace: undefined,
    kubernetesKubeconfig: undefined,
    kubernetesContext: undefined,
    kubernetesKubectlPath: "kubectl",
    kubernetesImagePullPolicy: "IfNotPresent",
    kubernetesServiceAccount: undefined,
    kubernetesAutomountServiceAccountToken: false,
    kubernetesIsolationMode: "standard",
    kubernetesRuntimeClass: undefined,
    kubernetesPriorityClass: undefined,
    kubernetesNodeSelectorJson: "{}",
    kubernetesTolerationsJson: "[]",
    kubernetesStartupTimeoutSeconds: 120,
    kubernetesCpuRequest: "250m",
    kubernetesCpuLimit: "2",
    kubernetesMemoryRequest: "512Mi",
    kubernetesMemoryLimit: "4Gi",
    kubernetesEphemeralStorageRequest: "1Gi",
    kubernetesEphemeralStorageLimit: "20Gi",
    kubernetesWorkspaceSizeLimit: "10Gi",
    ...
    kernelBrowserTimeoutSeconds: 3_600,
    kernelBrowserStealth: false,
    ...
    documentCurationProvider: "heuristic",
    documentCurationModel: "gpt-4o-mini",
    documentCurationApiKey: undefined,
    documentCurationBaseUrl: undefined,
