...
export function testSettings(overrides: Partial<Settings> = {}): Settings {
  return {
    ...
    knowledgeBankProvider: "heuristic",
    knowledgeBankModel: "gpt-4o-mini",
    knowledgeBankApiKey: undefined,
    knowledgeBankBaseUrl: undefined,
    knowledgeBankSweepIntervalMs: 900_000,
