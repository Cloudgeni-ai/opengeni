...
const createSheetEnvelope = (namespace, counter, name) => {
  ...
  envelope.write("OGAKC002", 0, "ascii");
  envelope.writeUInt16LE(2, 8);
...
const collaborationIntent = Buffer.from(
  "",
  "hex",
);
