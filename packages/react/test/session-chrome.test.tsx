...
describe("SessionChrome goal pill reasons", () => {
  ...
  test("spells out why a goal is paused", () => {
    ...
    expect(sessionChromeGoalPillLabel("paused", paused("user_pause").goal)).toBe("Paused · by you");
    expect(sessionChromeGoalPillLabel("paused", paused("api").goal)).toBe("Paused · by you");
