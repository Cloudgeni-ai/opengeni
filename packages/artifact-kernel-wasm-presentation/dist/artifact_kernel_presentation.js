/* @ts-self-types="./artifact_kernel_presentation.d.ts" */
...
export class ArtifactPresentationSession {
    static __wrap(ptr) {
        const obj = Object.create(ArtifactPresentationSession.prototype);
        obj.__wbg_ptr = ptr;
        ArtifactPresentationSessionFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        ArtifactPresentationSessionFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_artifactpresentationsession_free(ptr, 0);
    }
    /**
    ...
    applyCommands(command_envelope) {
        try {
            ...
            wasm.artifactpresentationsession_applyCommands(retptr, this.__wbg_ptr, ptr0, len0);
    ...
    static create(namespace_envelope) {
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            wasm.artifactpresentationsession_create(retptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
            ...
            return ArtifactPresentationSession.__wrap(r0);
        } finally {
            wasm.__wbindgen_add_to_stack_pointer(16);
        }
    }
     ...
     */
    dispose() {
        wasm.artifactpresentationsession_dispose(this.__wbg_ptr);
    }
    /**
    ...
    fork() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.artifactpresentationsession_fork(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
     ...
     */
    isClosed() {
        const ret = wasm.artifactpresentationsession_isClosed(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
    ...
    static open(snapshot) {
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            wasm.artifactpresentationsession_open(retptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
    ...
    query(query_envelope) {
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            wasm.artifactpresentationsession_query(retptr, this.__wbg_ptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
    ...
    revision() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.artifactpresentationsession_revision(retptr, this.__wbg_ptr);
    ...
    snapshot() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.artifactpresentationsession_snapshot(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
    ...
    stateHash() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.artifactpresentationsession_stateHash(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
...
if (Symbol.dispose) ArtifactPresentationSession.prototype[Symbol.dispose] = ArtifactPresentationSession.prototype.free;
 ...
 * @returns {Uint8Array}
 */
export function applyPresentationCommands(snapshot, command_envelope) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(snapshot, wasm.__wbindgen_export);
        const len0 = WASM_VECTOR_LEN;
        ...
        wasm.applyPresentationCommands(retptr, ptr0, len0, ptr1, len1);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
 ...
 * @returns {Uint8Array}
 */
export function canonicalizePresentationSnapshot(snapshot) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(snapshot, wasm.__wbindgen_export);
        const len0 = WASM_VECTOR_LEN;
        wasm.canonicalizePresentationSnapshot(retptr, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
 ...
 * @returns {Uint8Array}
 */
export function createPresentation(namespace_envelope) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(namespace_envelope, wasm.__wbindgen_export);
        const len0 = WASM_VECTOR_LEN;
        wasm.createPresentation(retptr, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
 ...
 * @returns {Uint8Array}
 */
export function queryPresentation(snapshot, query_envelope) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(snapshot, wasm.__wbindgen_export);
        const len0 = WASM_VECTOR_LEN;
        ...
        const len1 = WASM_VECTOR_LEN;
        wasm.queryPresentation(retptr, ptr0, len0, ptr1, len1);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./artifact_kernel_presentation_bg.js": import0,
    };
}

const ArtifactPresentationSessionFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_artifactpresentationsession_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('artifact_kernel_presentation_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
