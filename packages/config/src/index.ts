...
const SettingsSchema = z.object({
  ...
  knowledgeBankProvider: z.enum(["openai", "heuristic", "none"]).default("openai"),
  knowledgeBankModel: z.string().min(1).default("gpt-4o-mini"),
  knowledgeBankApiKey: z.string().optional(),
  knowledgeBankBaseUrl: z.string().url().optional(),
  knowledgeBankSweepIntervalMs: z.coerce.number().int().positive().default(900_000),
...
export function getSettings(): Settings {
  const raw = {
    ...
    knowledgeBankProvider: optional("OPENGENI_KNOWLEDGE_BANK_PROVIDER"),
    knowledgeBankModel: optional("OPENGENI_KNOWLEDGE_BANK_MODEL"),
    knowledgeBankApiKey: optional("OPENGENI_KNOWLEDGE_BANK_API_KEY"),
    knowledgeBankBaseUrl: optional("OPENGENI_KNOWLEDGE_BANK_BASE_URL"),
    knowledgeBankSweepIntervalMs: optional("OPENGENI_KNOWLEDGE_BANK_SWEEP_INTERVAL_MS"),
