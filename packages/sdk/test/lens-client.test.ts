...
import { OpenGeniLensClient } from "../src/lens";

describe("OpenGeni Lens SDK", () => {
  test("keeps Lens requests behind the optional client entry", async () => {
    ...
    const client = new OpenGeniLensClient(coreClient);
    ...
    expect(requests).toEqual([
      {
        method: "GET",
        path: `/v1/workspaces/${workspaceId}/lens/registrations`,
        body: undefined,
      },
      {
        method: "POST",
      ...
      {
        method: "POST",
        path: `/v1/workspaces/${workspaceId}/lens/repositories`,
        body: expect.objectContaining({ repositoryFullName: "example/repo" }),
      },
      {
        method: "DELETE",
        path: `/v1/workspaces/${workspaceId}/lens/registrations/registration%2F1`,
        body: undefined,
      },
      {
        method: "DELETE",
        path: `/v1/workspaces/${workspaceId}/lens/repositories/repository%2F1`,
        body: undefined,
      },
    ]);
  });
