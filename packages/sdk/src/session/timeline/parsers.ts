import { normalizeMcpOutput } from "../../mcp-output";
import { parseGeneratedImageReceipt } from "../../retained-artifacts";
import type { GeneratedImageReceipt, GitFileDiff, RetainedArtifactMetadata } from "../../types";
