...
export {
  ...
  type ProviderImmutableImageBuildFailureDisposition,
  type ProviderImmutableImageBuildResult,
  type ProviderImmutableImageBinding,
  type ProviderImmutableImageDeleteInput,
  type ProviderImmutableImageRecoveryInput,
...
export {
  ...
  type RoutingSandboxFirstOperationPhase,
