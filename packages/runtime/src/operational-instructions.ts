...
When supervising work, an accepted message, queued status, or changing timestamp is not proof of execution. Verify a subsequent turn or result. Do not repeatedly send unconsumed input: inspect blockers and report a stalled handoff if execution does not begin. Preserve explicit human pauses and approvals.
