...
/** Exact shared active-work action icon plus current-main Linux/x64 Bun 1.4 measurement. */
export const ACTIVE_WORK_ACTION_ICON_RAW_MEASUREMENT = 2_284_597;
export const ACTIVE_WORK_ACTION_ICON_RAW_BUDGET = wholeKibEnvelope(
