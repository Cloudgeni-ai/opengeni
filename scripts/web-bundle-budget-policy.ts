...
/** Exact durable composer attachment restoration Linux/x64 Bun 1.4 measurement. */
export const DURABLE_COMPOSER_ATTACHMENTS_RAW_MEASUREMENT = 2_281_075;
export const DURABLE_COMPOSER_ATTACHMENTS_RAW_BUDGET = wholeKibEnvelope(
  DURABLE_COMPOSER_ATTACHMENTS_RAW_MEASUREMENT,
);
export const DURABLE_COMPOSER_ATTACHMENTS_GZIP_MEASUREMENT = 639_495;
export const DURABLE_COMPOSER_ATTACHMENTS_GZIP_BUDGET = wholeKibEnvelope(
