...
/** Exact Rig recovery plus current-main Linux/x64 Bun 1.4 measurement. */
export const RIG_VERIFICATION_RECOVERY_CURRENT_MAIN_RAW_MEASUREMENT = 2_288_890;
export const RIG_VERIFICATION_RECOVERY_CURRENT_MAIN_RAW_BUDGET = wholeKibEnvelope(
  RIG_VERIFICATION_RECOVERY_CURRENT_MAIN_RAW_MEASUREMENT,
);
export const RIG_VERIFICATION_RECOVERY_CURRENT_MAIN_GZIP_MEASUREMENT = 641_938;
export const RIG_VERIFICATION_RECOVERY_CURRENT_MAIN_GZIP_BUDGET = wholeKibEnvelope(
  RIG_VERIFICATION_RECOVERY_CURRENT_MAIN_GZIP_MEASUREMENT,
);
export const RIG_VERIFICATION_RECOVERY_CURRENT_MAIN_FILE_COUNT = 32;
