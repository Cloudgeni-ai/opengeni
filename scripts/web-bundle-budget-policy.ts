...
/** Exact managed-social-sign-in plus current-main Linux/x64 Bun 1.4 measurement. */
export const MANAGED_SOCIAL_SIGN_IN_CURRENT_MAIN_RAW_MEASUREMENT = 2_226_486;
export const MANAGED_SOCIAL_SIGN_IN_CURRENT_MAIN_RAW_BUDGET = wholeKibEnvelope(
