...
/** Exact autonomous-memory current-main integration Linux/x64 Bun 1.4 high measurement. */
export const AUTONOMOUS_MEMORY_INTEGRATION_RAW_MEASUREMENT = 2_241_876;
export const AUTONOMOUS_MEMORY_INTEGRATION_RAW_BUDGET = wholeKibEnvelope(
