...
/** Exact governed Apps management Linux/x64 Bun 1.4 measurement. */
export const GOVERNED_APPS_MANAGEMENT_RAW_MEASUREMENT = 2_290_849;
export const GOVERNED_APPS_MANAGEMENT_RAW_BUDGET = wholeKibEnvelope(
