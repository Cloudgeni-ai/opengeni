...
/** Exact invited-account continuation plus current-main Linux/x64 Bun 1.4 measurement. */
export const ORGANIZATION_INVITATION_CONTINUATION_RAW_MEASUREMENT = 2_277_646;
export const ORGANIZATION_INVITATION_CONTINUATION_RAW_BUDGET = wholeKibEnvelope(
  ORGANIZATION_INVITATION_CONTINUATION_RAW_MEASUREMENT,
);

/** Exact authoritative Codex capacity-status plus current-main Linux/x64 Bun 1.4 measurement. */
export const CODEX_CAPACITY_LIVE_STATUS_RAW_MEASUREMENT = 2_279_737;
export const CODEX_CAPACITY_LIVE_STATUS_RAW_BUDGET = wholeKibEnvelope(
  CODEX_CAPACITY_LIVE_STATUS_RAW_MEASUREMENT,
);

/** Exact sidebar-density head and untouched current-main configured-API Linux/x64 measurement. */
export const SIDEBAR_DENSITY_CURRENT_MAIN_BROWSER_RAW_MEASUREMENT = 2_279_505;
export const SIDEBAR_DENSITY_CURRENT_MAIN_BROWSER_RAW_BUDGET = wholeKibEnvelope(
  SIDEBAR_DENSITY_CURRENT_MAIN_BROWSER_RAW_MEASUREMENT,
);

/** Exact setup-account query compatibility Linux/x64 Bun 1.3.14 measurement. */
export const SETUP_ACCOUNT_QUERY_COMPATIBILITY_RAW_MEASUREMENT = 2_281_164;
export const SETUP_ACCOUNT_QUERY_COMPATIBILITY_RAW_BUDGET = wholeKibEnvelope(
  SETUP_ACCOUNT_QUERY_COMPATIBILITY_RAW_MEASUREMENT,
);

/** Exact session-wait and command-wake lifecycle plus current-main Linux/arm64 measurement. */
export const SESSION_WAIT_COMMAND_WAKE_RAW_MEASUREMENT = 2_281_673;
export const SESSION_WAIT_COMMAND_WAKE_RAW_BUDGET = wholeKibEnvelope(
  SESSION_WAIT_COMMAND_WAKE_RAW_MEASUREMENT,
);

/** Exact session-row quick actions plus current-main configured-browser measurement. */
export const SESSION_ROW_QUICK_ACTIONS_RAW_MEASUREMENT = 2_284_688;
export const SESSION_ROW_QUICK_ACTIONS_RAW_BUDGET = wholeKibEnvelope(
