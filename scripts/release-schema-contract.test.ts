...
describe("release schema contract", () => {
  ...
  test("preserves published host-export history and appends the forward repair", async () => {
    ...
    const releaseSchemaContractHash = (includesActivation: boolean): string | null => {
      if (migrations.has("0333_atomic_connected_machine_attachments.sql")) {
        return includesActivation
          ? "58a497a1c76aa25bc9e2e3de99ef095c42c1b994dbfaa27d5744a71d015c796c"
          : "639b6db675697f2fd3625011bf744f2e22ecb49da7f689c345a9849b28da935b";
      }
    ...
    expect(contract.fileCount).toBe(
      108 +
        ...
        (migrations.has("0333_atomic_connected_machine_attachments.sql") ? 1 : 0),
    );
    ...
    expect(contract.latestMigration).toBe(
      migrations.has("0333_atomic_connected_machine_attachments.sql")
        ? "0333_atomic_connected_machine_attachments.sql"
