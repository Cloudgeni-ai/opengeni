...
describe("release schema contract", () => {
  ...
  test("preserves published host-export history and appends the forward repair", async () => {
    ...
    const releaseSchemaContractHash = (includesActivation: boolean): string | null => {
      if (migrations.has("0289_retire_legacy_standing_memory_mode.sql")) {
        return includesActivation
          ? "42c1b2277feb120d6b746dd378e61b219f90ef8d9b95ce37a310e3e1fb02c152"
          : "a65512d59877ca96cfb887a914a3835e17b6090af7383ec14904e340a4e56bc8";
      }
    ...
    expect(contract.fileCount).toBe(
      108 +
        ...
        (migrations.has("0289_retire_legacy_standing_memory_mode.sql") ? 1 : 0),
    );
    ...
    expect(contract.latestMigration).toBe(
      migrations.has("0289_retire_legacy_standing_memory_mode.sql")
        ? "0289_retire_legacy_standing_memory_mode.sql"
