...
describe("release schema contract", () => {
  ...
  test("preserves published host-export history and appends the forward repair", async () => {
    ...
    const releaseSchemaContractHash = (includesActivation: boolean): string | null => {
      if (migrations.has("0295_session_snapshot_and_pin_visibility.sql")) {
        return includesActivation
          ? "c55bc70f93faf75bf34bbf302bd71f0b9742675a0763e13f3ccddfb96e8919ed"
          : "fbfe96d9da9666b9311febe1df48342edc5b375e458009c52d21ed6d07175ae2";
      }
    ...
    expect(contract.fileCount).toBe(
      108 +
        ...
        (migrations.has("0295_session_snapshot_and_pin_visibility.sql") ? 1 : 0),
    );
    ...
    expect(contract.latestMigration).toBe(
      migrations.has("0295_session_snapshot_and_pin_visibility.sql")
        ? "0295_session_snapshot_and_pin_visibility.sql"
