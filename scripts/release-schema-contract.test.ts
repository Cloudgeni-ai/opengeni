  ...
  test("preserves published host-export history and appends the forward repair", async () => {
    ...
    const sessionVisibilityContractHash = (
      ...
      if (includesActivation) {
        return includesTurnInstructions
          ? "d99cab572f4b4352d39730ef6c16c436f8178f7cde07e8567e3660eb11497923"
          : "0a3c326f21e67422bdc84e9409d72b489aac967e18b08fbc7a410aab51cb17af";
      }
      return includesTurnInstructions
        ? "74d5c28784eadaf972bf8f8db9552d5bf72c30abd39c992cd0be086e58f2b594"
        : "d54a4ac5b800e0c0578e7fce7d1a09cea1dbed87d3b13bf722549fea0bdc031e";
    };
    const includesTurnInstructions = migrations.has("0229_realtime_turn_instructions.sql");
    ...
    expect(contract.fileCount).toBe(
      108 +
        ...
        (migrations.has("0229_realtime_turn_instructions.sql") ? 1 : 0) +
