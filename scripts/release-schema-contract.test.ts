  ...
  test("preserves published host-export history and appends the forward repair", async () => {
    ...
    expect(sourceContract.sha256).toBe(
      migrations.has("0223_pending_tool_event_output.sql")
        ? "5aef3b26dad278ead47cd216bf1e3e9d4b4dd0110af1ca35e26c49646746dc2d"
    ...
    const contract = {
      ...sourceContract,
      sha256: migrations.has("0223_pending_tool_event_output.sql")
        ? "5aef3b26dad278ead47cd216bf1e3e9d4b4dd0110af1ca35e26c49646746dc2d"
        : migrations.has("0222_session_visibility_authority_epochs.sql")
          ? "257511509811c24cc2e60afca38362b9a065924101fcd1df52850b01fbe5fafa"
          : migrations.has("0221_sessions_channel_index.sql")
    ...
    expect(contract.latestMigration).toBe(
      migrations.has("0223_pending_tool_event_output.sql")
        ? "0223_pending_tool_event_output.sql"
        : migrations.has("0222_session_visibility_authority_epochs.sql")
    ...
    expect(migrations.get("0223_pending_tool_event_output.sql")).toMatchObject({
      sha256: "93fda0cd9c6513167d356d0265cda93fb5fdb65be9ce2b3c9d8806cc8a42f34e",
      deploymentMode: "rolling",
    });
