...
describe("release schema contract", () => {
  ...
  test("preserves published host-export history and appends the forward repair", async () => {
    ...
    expect(sourceContract.sha256).toBe(
      migrations.has("0221_session_visibility_authority_epochs.sql")
        ? "d8076842d5e71d26a9eb77b7038855e47a00a242e9e329dc6baf0c1032c5f61c"
    ...
    const contract = {
      ...sourceContract,
      sha256: migrations.has("0221_session_visibility_authority_epochs.sql")
        ? "d8076842d5e71d26a9eb77b7038855e47a00a242e9e329dc6baf0c1032c5f61c"
        : migrations.has("0220_memory_slack_append_only_cascade.sql")
          ? migrations.has("0219_organization_tenancy_managed_human_provisioning.sql")
            ? "c9821a930c52d8c40604b9d2f39408227b377f3b2d70b4bb74c14ef93f605756"
    ...
    expect(contract.fileCount).toBe(
      108 +
        ...
        (migrations.has("0221_session_visibility_authority_epochs.sql") ? 1 : 0) +
    ...
    expect(contract.latestMigration).toBe(
      migrations.has("0221_session_visibility_authority_epochs.sql")
        ? "0221_session_visibility_authority_epochs.sql"
        : migrations.has("0220_memory_slack_append_only_cascade.sql")
    ...
    if (migrations.has("0221_session_visibility_authority_epochs.sql")) {
      expect(migrations.get("0221_session_visibility_authority_epochs.sql")).toMatchObject({
