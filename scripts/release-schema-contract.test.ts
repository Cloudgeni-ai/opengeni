...
describe("release schema contract", () => {
  ...
  test("preserves published host-export history and appends the forward repair", async () => {
    ...
    expect(
      ...
      sha256: "109eee2e7d65c7a067fc4b4a40c0c87f704e4a9da22fcb8b4b12c274cd371f97",
      deploymentMode: "rolling",
    });
    expect(
      completeSourceContract.migrations.find(
    ...
    const releaseSchemaContractHash = (includesActivation: boolean): string | null => {
      if (migrations.has("0326_interaction_operation_error_codes.sql")) {
        return includesActivation
          ? "d4944e04ff727431df22ed788f2d6b8d82fdb5c830d22fde370b162c93856c7c"
          : "7b11790d262f6dbdb481dada967ae9c05acce84eca80128c2eb47fecb9943b3d";
      }
