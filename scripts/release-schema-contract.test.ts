  ...
  test("preserves published host-export history and appends the forward repair", async () => {
    ...
    expect(sourceContract.sha256).toBe(
      migrations.has("0225_session_visibility_fork_activation.sql")
        ? "e8727b1824a578fa00f1af6b636188a4e5422a93bb1ec0917bbe48ec1d79b7dd"
    ...
    const contract = {
      ...sourceContract,
      sha256: migrations.has("0225_session_visibility_fork_activation.sql")
        ? "e8727b1824a578fa00f1af6b636188a4e5422a93bb1ec0917bbe48ec1d79b7dd"
        : migrations.has("0222_session_visibility_authority_epochs.sql")
          ? "257511509811c24cc2e60afca38362b9a065924101fcd1df52850b01fbe5fafa"
          : migrations.has("0221_sessions_channel_index.sql")
    ...
    if (migrations.has("0225_session_visibility_fork_activation.sql")) {
      expect(migrations.get("0225_session_visibility_fork_activation.sql")).toMatchObject({
        sha256: "e851718b56ff83da207ccb89e2851a2c7cdfe8a23c2e899573776284e94fbc5e",
        deploymentMode: "rolling",
      });
    }
