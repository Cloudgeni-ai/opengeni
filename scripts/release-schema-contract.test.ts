...
describe("release schema contract", () => {
  ...
  test("preserves published host-export history and appends the forward repair", async () => {
    ...
    expect(sourceContract.sha256).toBe(
      migrations.has("0225_integration_facet_authority_cutover.sql")
        ? "beb223eaa41d2dc20af834b1e77d95f128c2c098b90c901c95ad804de374eccd"
        : migrations.has("0223_integration_definition_identity_cutover.sql")
          ? "726e2d8e0210dd58f9b66eeb2ff09c8f296b5aa4ebd7a5c991913e874efe443b"
    ...
    const contract = {
      ...sourceContract,
      sha256: migrations.has("0225_integration_facet_authority_cutover.sql")
        ? "beb223eaa41d2dc20af834b1e77d95f128c2c098b90c901c95ad804de374eccd"
        : migrations.has("0223_integration_definition_identity_cutover.sql")
          ? "726e2d8e0210dd58f9b66eeb2ff09c8f296b5aa4ebd7a5c991913e874efe443b"
          : migrations.has("0228_slack_task_policy.sql")
    ...
    expect(contract.fileCount).toBe(
      108 +
        ...
        (migrations.has("0223_integration_definition_identity_cutover.sql") ? 1 : 0) +
        (migrations.has("0225_integration_facet_authority_cutover.sql") ? 1 : 0),
    );
        ...
        : migrations.has("0227_slack_native_actions.sql")
          ...
          : migrations.has("0224_slack_post_outcome_reconciliation.sql")
            ...
            : migrations.has("0223_sessions_channel_fk_validate.sql")
              ...
              : migrations.has("0223_integration_definition_identity_cutover.sql")
                ? "0223_integration_definition_identity_cutover.sql"
                : migrations.has("0221_sessions_channel_index.sql")
    ...
    if (migrations.has("0223_integration_definition_identity_cutover.sql")) {
      expect(migrations.get("0223_integration_definition_identity_cutover.sql")).toMatchObject({
        sha256: "535a806746d99d9b338df230c133477ca0e3d554ae6950077a3409b077f4b1cb",
        deploymentMode: "maintenance",
      });
    }
    if (migrations.has("0225_integration_facet_authority_cutover.sql")) {
      expect(migrations.get("0225_integration_facet_authority_cutover.sql")).toMatchObject({
