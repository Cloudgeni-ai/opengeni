...
import {
  AUTONOMOUS_MEMORY_INTEGRATION_RAW_BUDGET,
  AUTONOMOUS_MEMORY_INTEGRATION_RAW_MEASUREMENT,
...
describe("web bundle budget policy", () => {
  ...
  test("retains the exact autonomous-memory current-main integration envelope", () => {
    expect(AUTONOMOUS_MEMORY_INTEGRATION_RAW_MEASUREMENT).toBe(2_241_876);
    expect(AUTONOMOUS_MEMORY_INTEGRATION_RAW_BUDGET).toBe(2191 * KIB);
    expect(
      AUTONOMOUS_MEMORY_INTEGRATION_RAW_BUDGET - AUTONOMOUS_MEMORY_INTEGRATION_RAW_MEASUREMENT,
    ).toBe(1_708);
    expect(
      AUTONOMOUS_MEMORY_INTEGRATION_RAW_BUDGET - AUTONOMOUS_MEMORY_INTEGRATION_RAW_MEASUREMENT,
