...
import {
  ...
  GOVERNED_APPS_MANAGEMENT_RAW_BUDGET,
  GOVERNED_APPS_MANAGEMENT_RAW_MEASUREMENT,
...
describe("web bundle budget policy", () => {
  ...
  test("retains the exact governed Apps management envelope", () => {
    expect(GOVERNED_APPS_MANAGEMENT_RAW_MEASUREMENT).toBe(2_290_849);
    expect(GOVERNED_APPS_MANAGEMENT_RAW_BUDGET).toBe(2239 * KIB);
    expect(GOVERNED_APPS_MANAGEMENT_RAW_BUDGET - GOVERNED_APPS_MANAGEMENT_RAW_MEASUREMENT).toBe(
      1_887,
    );
  });
