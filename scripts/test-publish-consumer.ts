...
try {
  ...
  await Promise.all([
    ...
    writeFile(
      ...
      [
        'import { EDITABLE_ARTIFACT_INTENT_PROTOCOL_VERSION, EDITABLE_ARTIFACT_INTENT_VERSION, currentEditableArtifactCompatibility, decodeEditableArtifactMutationIntent, encodeEditableArtifactMutationIntent, hashEditableArtifactMutationIntent, hashEditableArtifactMutationIntentBytes, type EditableArtifactMutationIntent } from "@opengeni/contracts/editable-artifacts";',
        ...
        "",
        'const current = currentEditableArtifactCompatibility("spreadsheet");',
        ...
        'const liveEncoded = encodeEditableArtifactLiveServerWireFrame({ type: "watermark", protocolVersion: current.liveProtocolVersion, artifactId: "11111111111111111111111111111111", streamEpoch: "packed-contract-proof", headSequence: 1 });',
        ...
        'const liveTransport = createEditableArtifactHttpLiveTransport({ baseUrl: "http://127.0.0.1:3000", workspaceId: "packed-workspace", ...current, kernelVersion: "packed-kernel", allowInsecureDevelopmentTransport: true });',
