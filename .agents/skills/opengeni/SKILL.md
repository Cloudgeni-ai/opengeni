...
- Personal Connection session consent is independent of private-session product activation after migration 0474. Use `Session.connectionContext` for current visibility/epoch; retain owner, explicit consent, immutable accepted-turn, and live-use checks. Standing grants and other resource kinds remain activation-gated. See `docs/organization-tenancy.md`.
