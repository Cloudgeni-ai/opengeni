...
const SCENARIOS: Scenario[] = [
  ...
  {
    id: "text-minmax",
    title: "HI · text min/max length",
    allowSkip: false,
    questions: [
      {
        id: "rationale",
        kind: "text",
        prompt: "Why are we promoting to production?",
        label: "Promotion rationale",
        helpText: "Between 20 and 120 characters.",
        options: [],
        required: true,
        allowOther: false,
        validation: { minLength: 20, maxLength: 120 },
      },
    ],
  },
  {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        required: true,
        allowOther: false,
        validation: { minLength: 8, maxLength: 160 },
      },
    ],
  },
  {
