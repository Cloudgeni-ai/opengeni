...
<Note>
Skills, Packs, and the capability catalog are evolving quickly. The current contracts live in the repository under [docs/capabilities.md](https://github.com/Cloudgeni-ai/opengeni/blob/main/docs/capabilities.md) and [docs/packs.md](https://github.com/Cloudgeni-ai/opengeni/blob/main/docs/packs.md).
</Note>
