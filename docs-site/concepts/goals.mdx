...
## Reports are artifact deliverables

User-facing reports are native document Artifacts, including reports produced
while doing another task—for example, a Knowledge organization audit. The agent
declares the report before authoring, creates the document through the Documents
Skill, inspects the relevant content after its final edit, and provides the
artifact reference in its handoff.
