...
For product integrations, the [chat setup](/guides/integrate-your-product#connect-your-backend) requires a compatible SDK and API deployment. Verify the installed package and target deployment before integrating, whether managed or self-hosted; a feature in source or documentation is not proof of support on a live deployment.
...
- **Agent Knowledge.** Files, retained source text and useful findings connect in one searchable library, with personal and workspace ownership and optional review.
