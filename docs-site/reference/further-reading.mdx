...
- [Sandbox Environments](https://github.com/Cloudgeni-ai/opengeni/blob/main/docs/rigs.md) and [Packs](https://github.com/Cloudgeni-ai/opengeni/blob/main/docs/packs.md): versioned sandbox definitions and capability bundles.
