    ...
    server.registerTool(
      ...
      async ({
        ...
        const dbPage = await listSessionEventPage(deps.db, grant.workspaceId, sessionId, {
          ...
          ...(mode === "monitoring" ? { claimedConversationOnly: true } : {}),
