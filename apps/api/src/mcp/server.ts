      ...
      "session_wait",
      {
        ...
        inputSchema: {
          ...
          waitFor: z4
            ...
            .optional()
            .describe(
              "change (default) returns on relevant activity; completion ignores goal/progress events and waits for a result, settlement, or blocker.",
            ),
