...
describe("Rig verification Temporal dispatch policy", () => {
  test("restarts failed attempts without widening automation duplicate handling", () => {
    ...
    expect(rigVerification).toContain('workflowIdReusePolicy: "ALLOW_DUPLICATE_FAILED_ONLY"');
  });
});
