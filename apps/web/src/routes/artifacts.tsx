  ...
  return (
    <ContentPage width="standard">
      <PageHeader
        ...
        title="Artifacts"
        description="Pages, apps, visualizations, and other HTML experiences created in this workspace."
        actions={
  ...
  return (
    <ContentPage width="wide">
      ...
      <PageHeader
        ...
        description={detail?.artifact.description ?? "A workspace HTML artifact."}
        actions={
