      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <p className="mt-1 max-w-2xl text-xs text-fg-muted">
            Let members with permission to start chats create a session that only they can open.
            Personal workspaces are always private and do not depend on this setting.
          </p>
        </div>
        {settings ? (
          <Button
