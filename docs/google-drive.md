...
Scheduler dispatch, source rows, content ingestion, backfill, cursor processing,
ACL projection, policy-UI wiring, and memory updates remain blocked on the
common source/fact foundation.
