...
0431 without repinning published migration hashes. The browser tree-shaking fix
...
that migration 0431 prevents deletion of an installed-only workspace which was
