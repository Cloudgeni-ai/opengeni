...
## Unified Knowledge cutover (0459)

`0459_unified_knowledge.sql` is a maintenance migration. Stop every API,
...
Never restart a pre-0459 runtime after commit. Rollback requires restoring the
