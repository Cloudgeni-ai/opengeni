...
use the original claim/prepare capabilities while the new API uses additive v2
capabilities; do not deploy the new API against a pre-0401 database.
...
that recovered transport before provider I/O.
