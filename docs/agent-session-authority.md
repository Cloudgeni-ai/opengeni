...
verify subsequent turns/results through the existing session observation tools,
retain consumed event cursors, and inspect blockers instead of duplicating
