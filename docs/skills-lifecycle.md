...
The exact 0429 runner stage executes inside an explicit migration transaction:
...
The same atomic 0429 runner calls `packages/db/src/skill-config-migration.ts`
