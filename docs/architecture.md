...
| Codex adaptive-fleet policy / deterministic shadow replay | `packages/contracts/src/codex-fleet-policy.ts`, `apps/worker/src/activities/codex-fleet-shadow.ts` | [`codex-subscription-rotation.md`](codex-subscription-rotation.md) |
...
| [`codex-subscription-rotation.md`](codex-subscription-rotation.md) | Workspace-local Codex selection, leases, failover/capacity waits, and the default-off adaptive-fleet shadow/replay contract. |
