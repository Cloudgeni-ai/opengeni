...
| Explicit agent-directed durable writes | `docs/explicit-durable-writes.md` | Agent-tool/API integration and tests should link here instead of bypassing the OPE-183 router, trusting model-supplied authority, or exposing rollback tokens. |
