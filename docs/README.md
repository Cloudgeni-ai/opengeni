...
| OpenGeni Sites | `docs/sites.md` | `README.md`, architecture, SDK/runtime docs, and UI copy should link instead of restating the iframe, release, capability, data-residence, or rollout boundaries. |
| Advanced application deployments | `docs/internal-applications.md` | Deployment UI, Kubernetes provider code, SINTEF examples, and architecture should link instead of creating a second lifecycle or weakening plan/approval/reconciliation authority. |
