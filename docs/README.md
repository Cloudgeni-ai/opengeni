...
| Durable waits & one-shot background jobs | `docs/durable-waits-and-background-jobs.md` | `docs/run-lifecycle.md`, `docs/architecture.md`, SDK/API/UI summaries should link instead of restating state-machine details. |
