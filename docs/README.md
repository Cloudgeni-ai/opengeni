...
| Google Drive source preview | `docs/google-drive.md` | Documents UI and connector code should link instead of restating OAuth scope and no-ingestion boundaries. |
