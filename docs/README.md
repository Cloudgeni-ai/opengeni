...
| Session realtime voice | `docs/realtime-voice.md` | Architecture, SDK/React docs, and host-app guides should link instead of restating protocol evidence, authorization, or durable-turn semantics. |
