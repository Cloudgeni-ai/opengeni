...
- Pack catalog and installation routes under `/v1/packs`
- Social connector routes under `/v1/social`
- OpenGeni MCP tools:
...
```bash
curl -X POST http://127.0.0.1:8000/v1/packs/marketing-social-daily-analysis/enable \
...
```bash
curl -X POST http://127.0.0.1:8000/v1/social/connections \
  -H 'content-type: application/json' \
  -d '{
    "provider": "linkedin",
...
```bash
curl -X POST http://127.0.0.1:8000/v1/social/posts \
  -H 'content-type: application/json' \
  -d '{
...
```bash
curl -X POST http://127.0.0.1:8000/v1/packs/marketing-social-daily-analysis/scheduled-tasks \
  -H 'content-type: application/json' \
  -d '{
