/** OPENGENI wordmark, vector taken from the opengeni.ai site header. */
const PATH =
...
export const WORDMARK_RATIO = 958.43 / 100;

export function Wordmark({ height, color }: { height: number; color: string }) {
  return (
    <svg width={height * WORDMARK_RATIO} height={height} viewBox="0 0 958.43 100" role="img" aria-label="Opengeni">
